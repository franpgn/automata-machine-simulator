...
class TuringMachine(AbstractMachine):
    def __init__(self, blank_symbol='_', initial_state='q0', final_states=None, reject_states=None, transition_function=None):
        super().__init__()
        self.blank_symbol = blank_symbol
        self.head_position = 0
        self.current_state = initial_state
        self.initial_state = initial_state  # Armazena o estado inicial
    ...
    def load_input(self, input_data):
        ...
        self.head_position = 0
        self.current_state = self.initial_state  # Garantir que inicie no estado inicial ao carregar a entrada
